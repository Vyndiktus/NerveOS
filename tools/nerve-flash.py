#!/usr/bin/env python3
"""
nerve-flash — NerveOS image flasher

Flashes a pre-built NerveOS image onto a connected device via fastboot.

Usage:
    python nerve-flash.py --device cepheus [--serial SERIAL] [--images-dir PATH]
...
def flash_device(serial: str, profile: dict, images_dir: Path, dry_run: bool):
    ...
    if not dry_run:
        ...
        print("         nerved will start automatically and attempt to join the hive.")
    else:
