#!/usr/bin/env python3
"""
nerve-identify — NerveOS USB device identifier
...
Usage:
    python nerve-identify.py [--watch] [--devices-dir PATH]
"""
...
def print_device_report(serial: str, mode: str, device_info: dict, profile: dict | None):
    ...
    if profile:
        ...
        print(f"      Flash : nerve-flash.py --device {profile['id']} --serial {serial}")
